    ...
    >
      <div className="flex items-center align-middle">
        <div data-aos="zoom-in">
          <Image
            className="rounded-sm object-center w-[15rem] sm:w-[15rem] md:w-[20rem] lg:w-[15rem]"
            width={300}
            height={300}
            src={image}
            alt="project logo"
                ...
                <div key={index} className="flex ">
                  <div key={index}>
                    <Image
                      ...
                      src={tech}
                      alt={`tech-icon-${index}`}
                      className="mx-1 lg:w-4 lg:h-4 w-1 h-2 md:w-5 md:h-5 lg:mb-2"
                    />
                  </div>
                </div>
              ))}
