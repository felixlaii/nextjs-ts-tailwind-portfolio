        ...
        >
          <div className=" max-w-full rounded-lg">
            <a href={`#${i.toString()}`}>
              <video
                id={i.toString()}
                className="rounded-full object-cover opacity-80 mt-1 sm:mt-[1rem] lg:mt-[1rem] md:mt-[10rem] xl:mt-[1rem] md:mt-[1rem]  z-10 h-[3rem] w-[3.5rem] sm:h-[3rem] sm:w-[3rem] md:h-[4rem] md:w-[4.2rem] lg:h-[4.2rem] lg:w-[4.2rem]"
              >
