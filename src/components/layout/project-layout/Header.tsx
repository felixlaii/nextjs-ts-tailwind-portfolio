  ...
  return (
    <div className={`  ${darkMode && "dark"}`}>
      <header
        ...
        } transition-all duration-200 bg-brand-headerbg dark:bg-brand-dark flex font-custom font-primary font-extralight justify-between w-full items-center pb-2`}
      >
        {" "}
